...
- **Homepage plan snapshot**: the home page now loads authenticated plan data to highlight the current plan and show compact links for recent plans from the last 4 weeks.
