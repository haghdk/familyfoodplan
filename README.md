...
- **Homepage current-plan meal table**: the home page now loads plan list data, fetches the selected current plan details, and renders a compact day/lunch/dinner table with UTC day labels and safe meal fallbacks.
